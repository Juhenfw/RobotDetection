...
def main():
    ...
    parser.add_argument('--source', type=str, default='C:/Users/YMPI/Downloads/PuduVideo2/10.109.61.157_01_20250412135831922.mp4', help='Video source (0 for webcam, or path to video file)')
    ...
    while True:
        ...
        display_frame = cv2.resize(frame, (1280, 720))  # Atur ukuran sesuai kebutuhan
